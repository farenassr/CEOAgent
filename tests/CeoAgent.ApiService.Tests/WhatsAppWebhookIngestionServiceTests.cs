...
{
    [Test]
    public async Task IngestAsync_WhenWebhookIsDuplicated_DoesNotEnqueueSecondJob()
    {
        ...
        parsedLog.Message.ShouldContain("From=15551234567");
        parsedLog.Message.ShouldContain("MessageType=text");
        parsedLog.Message.ShouldContain("Text=Hola");
    }
